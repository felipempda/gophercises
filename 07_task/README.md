...
- Packages cobra, bbolt
- More "advanced" command line options with cobra
- Simple Database transactions with bbolt
- Conversion from binary to uint64

## Logs

```bash
felipe.moreno@HOST task % ./task list
felipe.moreno@HOST task % ./task add My first task
task added successfully
felipe.moreno@HOST task % ./task add My second task
task added successfully
felipe.moreno@HOST task % ./task list
1 - My first task
2 - My second task
felipe.moreno@HOST task % ./task delete 1
task deleted successfully
felipe.moreno@HOST task % ./task list
2 - My second task
felipe.moreno@HOST task %
```

## Overview from [gophercises](https://github.com/gophercises/task):
